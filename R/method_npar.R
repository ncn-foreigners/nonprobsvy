...
#' Estimation of the mean is done using the \eqn{S_{\text{P}}} probability sample.
#'
...
#'
#' \deqn{
#' \hat{V}_1 = \frac{1}{N^2} \sum_{i=1}^{n_{\text{NP}}} \left\lbrace\hat{g}_{\text{P}}(\boldsymbol{x}_i)\right\rbrace^{2} \hat{e}_i^2,
#' }
#'
