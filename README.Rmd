...
-   see the working paper Chrostowski, Ł., Chlebicki, P., & Beręsewicz, M. (2025). 
    *nonprobsvy--An R package for modern methods for non-probability surveys*. 
    arXiv preprint [arXiv:2504.04255](https://arxiv.org/abs/2504.04255) -- forthcomming to the Journal of Statistical Software
...
-   unit-level data is available for the non-probability sample $S_A$
    ...
    $k \in S_A$ otherwise $R_k=0$, $y_k$ is observed only for sample
    $S_A$ and $\boldsymbol{x}_k$ is observed in both $S_A$ and $S_B$.
