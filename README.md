...
- unit-level data is available for the non-probability sample $A$, i.e. 
  $(y_k, \boldsymbol{x}_k)$ is available for all units $k \in S_A$, and
  population-level data is available for
